...
<body>
	...
	<nav class="navbar navbar-light bg-light">
		...
		<div class="<%=className%>" role="alert" id="alert"
			style="display: <%=display%>"><%=msg%></div>
		...
		<div class="dropdown align-middle">
			<div id="userMenu">
				...
				<button class="btn dropdown-toggle" type="button" id="btnUser"
					...
					<i class="material-icons">account_circle</i> <span id="userName">${user.firstName}
						${user.lastName}</span>
				</button>
	...
	<nav class="navbar navbar-expand-lg navbar-dark font-weight-bold"
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav mx-auto">
				<li class="nav-item"><a class="nav-link text-light ml-4"
					href="clAccounts.do">Cuentas </a></li>
