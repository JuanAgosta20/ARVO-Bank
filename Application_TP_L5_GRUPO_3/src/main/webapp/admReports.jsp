	...
	<h4 class="text-blue" style="height:50px">Informes</h4>
		<div class="row">
			...
			<div class="col-2">
				...
				<br></br>
				<label label-for="desde">Desde: </label>
				<input id="desde" type="date"></input>
				<br></br>
				<label label-for="hasta">Hasta: </label>
				<input id="hasta" type="date"></input>
			</div>
			<div class="col-10">
...
<script
	...
	<script
	src="Resources/js/Charts.js"></script>
</html>