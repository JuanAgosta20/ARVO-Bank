...
public class App {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// LOCACIONES
			Countrie countries[] = { Utilities.createCountrie("Afganist�n"), // 0
					...
					Utilities.createCountrie("Ant�rtida"), // 7
					...
					Utilities.createCountrie("Azerbay�n"), // 16
					Utilities.createCountrie("B�lgica"), // 17
					...
					Utilities.createCountrie("Ben�n"), // 23
					Utilities.createCountrie("Bhut�n"), // 24
					...
					Utilities.createCountrie("Brun�i"), // 31
					...
					Utilities.createCountrie("Camer�n"), // 37
					Utilities.createCountrie("Canad�"), // 38
					...
					Utilities.createCountrie("Emiratos �rabes Unidos"), // 59
					Utilities.createCountrie("Eritrea"), // 60
					Utilities.createCountrie("Eslovaquia"), // 61
					Utilities.createCountrie("Eslovenia"), // 62
					Utilities.createCountrie("Espa�a"), // 63
					Utilities.createCountrie("Estados Unidos de Am�rica"), // 64
					Utilities.createCountrie("Estonia"), // 65
					Utilities.createCountrie("Etiop�a"), // 66
					...
					Utilities.createCountrie("Gab�n"), // 71
					...
					Utilities.createCountrie("Islas Salom�n"), // 115
					...
					Utilities.createCountrie("M�xico"), // 140
					Utilities.createCountrie("M�naco"), // 141
					Utilities.createCountrie("Macao"), // 142
					Utilities.createCountrie("Maced�nia"), // 143
					...
					Utilities.createCountrie("Om�n"), // 170
					Utilities.createCountrie("Pa�ses Bajos"), // 171
					Utilities.createCountrie("Pakist�n"), // 172
					Utilities.createCountrie("Palau"), // 173
					Utilities.createCountrie("Palestina"), // 174
					Utilities.createCountrie("Panam�"), // 175
					Utilities.createCountrie("Pap�a Nueva Guinea"), // 176
					Utilities.createCountrie("Paraguay"), // 177
					Utilities.createCountrie("Per�"), // 178
					...
					Utilities.createCountrie("Rep�blica Centroafricana"), // 185
					Utilities.createCountrie("Rep�blica Checa"), // 186
					Utilities.createCountrie("Rep�blica Dominicana"), // 187
					Utilities.createCountrie("Reuni�n"), // 188
					Utilities.createCountrie("Ruanda"), // 189
					Utilities.createCountrie("Ruman�a"), // 190
					...
					Utilities.createCountrie("San Bartolom�"), // 195
					Utilities.createCountrie("San Crist�bal y Nieves"), // 196
					Utilities.createCountrie("San Marino"), // 197
					Utilities.createCountrie("San Mart�n (Francia)"), // 198
					Utilities.createCountrie("San Pedro y Miquel�n"), // 199
					Utilities.createCountrie("San Vicente y las Granadinas"), // 200
					Utilities.createCountrie("Santa Elena"), // 201
					Utilities.createCountrie("Santa Luc�a"), // 202
					Utilities.createCountrie("Santo Tom� y Pr�ncipe"), // 203
					...
					Utilities.createCountrie("Sud�frica"), // 212
					Utilities.createCountrie("Sud�n"), // 213
					Utilities.createCountrie("Suecia"), // 214
					Utilities.createCountrie("Suiza"), // 215
					Utilities.createCountrie("Surin�m"), // 216
					Utilities.createCountrie("Svalbard y Jan Mayen"), // 217
					Utilities.createCountrie("Swazilandia"), // 218
					Utilities.createCountrie("Tadjikist�n"), // 219
					Utilities.createCountrie("Tailandia"), // 220
					Utilities.createCountrie("Taiw�n"), // 221
					Utilities.createCountrie("Tanzania"), // 222
					Utilities.createCountrie("Territorio Brit�nico del Oc�ano �ndico"), // 223
					Utilities.createCountrie("Territorios Australes y Ant�rticas Franceses"), // 224
					...
					Utilities.createCountrie("Turkmenist�n"), // 231
					Utilities.createCountrie("Turqu�a"), // 232
					...
					Utilities.createCountrie("Uzbekist�n"), // 237
			...
			Province provs[] = { Utilities.createProvince("Misiones", 54), // 1
					...
					Utilities.createProvince("Entre R�os", 30), // 4
					Utilities.createProvince("Santa Cruz", 78), // 5
					Utilities.createProvince("R�o Negro", 62), // 6
					Utilities.createProvince("Chubut", 26), // 7
					Utilities.createProvince("C�rdoba", 14), // 8
					...
					Utilities.createProvince("Tucum�n", 90), // 16
					Utilities.createProvince("Neuqu�n", 58), // 17
					...
					Utilities.createProvince("Ciudad Aut�noma de Buenos Aires", 02), // 22
